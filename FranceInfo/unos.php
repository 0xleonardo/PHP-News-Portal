        ...
        if (array_key_exists('user',$_SESSION) && array_key_exists('level',$_SESSION)) {
            ...
            <main>
                <section class="wrapper naslov">
                    ...
                    <form action="skripta.php" method="POST" class="forma" name="forma" enctype="multipart/form-data">
                        <section>
                            <div class="form-item">
                        ...
                        <section>
                            <div class="form-item">
                                ...
                                <div class="form-field">
                                    <input type="file" accept="image/jpeg, image/gif, image/jpg, image/png" class="input-text" id="pphoto" name="pphoto"/>
                                </div>
